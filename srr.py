...
from social_robotics_reward.reward_signal_visualizer import RewardSignalVisualizer
...
async def main() -> None:
    ...
    with _audio_frame_generator as audio_frame_generator, _video_frame_generator as video_frame_generator:
        ...
        plot_drawer = RewardSignalVisualizer(frame_downsample_ratio=args.video_frame_downsample_ratio, reward_window_width=args.reward_window_width)
